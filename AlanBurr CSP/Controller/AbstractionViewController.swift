...
public class AbstractionViewController: UIPageViewController, UIPageViewControllerDataSource
{
    ...
    //Helper method to retrive the correct ViewController
    ...
    //MARK:- Required Protocol method for UIPageViewControllerDataSource
    ...
    public func pageViewController(_ pageViewContoller: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController?
    {
        guard let viewControllerIndex = orderedAbstractionViews.index(of: viewController)
        else
        {
